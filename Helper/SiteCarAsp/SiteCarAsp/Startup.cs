...
namespace SiteCarAsp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IDataProvider<TestDrive>>(new FileDataProvider<TestDrive>(Configuration["DbPath:TestDrive"]));
            services.AddSingleton<IDataProvider<Credit>>(new FileDataProvider<Credit>(Configuration["DbPath:Credit"]));
